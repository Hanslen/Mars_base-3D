...
public:
    ...
    void SetDriverEyePosition(float x, float y, float z);
	...
	*/
    ...
    float driverEyePosition[3];
    int driver;
    float driverRotate;
    float changeDegree;
    int getDriver();
    void setDriver(int stop);
    void setDriverRotate(float degree, float degree2);
